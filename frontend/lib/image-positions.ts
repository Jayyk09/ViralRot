...
export const MEDIUM_POSITIONS: Record<
    MediumImagePosition,
    PositionCoordinates
> = {
...
export const SMALL_POSITION_LIST: SmallImagePosition[] = [
    "right-high",
    "right-mid",
    "right-low",
];
export const MEDIUM_POSITION_LIST: MediumImagePosition[] = [
    "top-left",
    "top-right",
    "bottom-right",
];
 ...
 */
export function isValidPositionForSize(
    size: ImageSize,
...
export function getAvailablePositions(
    ...
    const usedPositions = new Set(
        currentImages.map((img) => img.position).filter(Boolean),
    );
