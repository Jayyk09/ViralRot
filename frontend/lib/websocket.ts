...
export class JobProgressManager {
    ...
    private setupEventListeners(): void {
        ...
        this.ws.onclose = (event) => {
            ...
            if (
                this.lastProgress?.type === "completed" ||
                this.lastProgress?.type === "error"
            ) {
                this.onDisconnect?.();
                return;
            }
    ...
    private attemptReconnect(): void {
        ...
        console.log(
            `Reconnecting to job ${this.jobId} in ${delay}ms (attempt ${this.reconnectAttempts}/${this.options.maxReconnectAttempts})`,
        );
