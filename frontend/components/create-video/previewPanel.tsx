...
export function PreviewPanel({selectedLine, video} : PreviewPanelProps) {
    ...
    return   (
        <div>
            <div
                ref={widthRef}
                className="h-full aspect-[9/16] relative"
            >

                <video className="absolute inset-0" autoPlay muted loop src={video} ></video>
                ...
                //put 
                <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2">{selectedLine.caption}</div>
