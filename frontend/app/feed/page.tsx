...
function FeedContent() {
    ...
    const {
        ...
        getNextPageParam: (lastPage: {
            ...
            const nextOffset =
                lastPage.collection_offset + lastPage.collection_limit;
    ...
    const videos: VideoWithMetadata[] =
        selectedCollectionId === null
            ? (allVideosData?.pages.flatMap(
                  (page: { videos: VideoResponse[] }) => page.videos,
              ) ?? [])
    ...
    const error =
        selectedCollectionId === null ? allVideosError : collectionError;
    const status =
        selectedCollectionId === null ? allVideosStatus : collectionStatus;
    ...
    useEffect(() => {
        if (allVideosData) {
            ...
            const lastPage =
                allVideosData.pages[allVideosData.pages.length - 1];
            console.log(
